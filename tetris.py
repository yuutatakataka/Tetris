...
class TetrisField():
    ...
    def judge_can_move(self, block, direction):
        ...
        # 移動後のブロックの座標の集合とフィールドの既に埋まっている座標の集合の積集合作成
